...
<Meta title="Components/Component/Header" />

# Header

`Header` is a header placed at the top of a page.

<Canvas>
  <div className="waykeecom-header">
    <div className="waykeecom-header__logo">
      <h2 className="waykeecom-no-margin">
        <span className="waykeecom-sr-only" id="wayke-ecom-title">Wayke Ecom</span>
        <svg className="waykeecom-header__logo--wordmark" viewBox="0 0 548.95 123.3" preserveAspectRatio="xMinYMid" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <svg className="waykeecom-header__logo--symbol" viewBox="0 0 185.57 109.13" preserveAspectRatio="xMinYMid" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
